...
function html2json(html) {
  ...
  var inline = makeMap("a,abbr,acronym,applet,b,basefont,bdo,big,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var");
